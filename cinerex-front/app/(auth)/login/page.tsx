    ...
    return (
        <div className="flex justify-center items-center min-h-screen">
            <Form className="bg-gradient-to-r from-purple-800 to-blue-900 py-10 px-20 rounded-md flex flex-col items-center" onSubmit={handleSubmit}>
                ...
                {error && (
                    <div key="error" className="mb-4 text-red-400 font-semibold">{error}</div>
                )}
                <div className="flex flex-col gap-4 my-10 items-center" key="inputs">
                    <Input 
                        key="email"
                        className="mx-10" 
                        variant="underlined" 
                ...
                <div className="flex flex-col items-center gap-4" key="actions">
                    <Button 
                        key="submit"
                    ...
                    <p key="signup-link" className="text-white">
